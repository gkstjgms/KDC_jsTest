...
const catNames = require("./catNames.js");
const dataValidator = require("./dataValidation.js");
...
const allRequests = async () => {
            ...
            tasks.push(
                fetcher({
                    ...
                    .then((res) => {
                        ...
                        console.log(`${apiUrl} ==> ${breed.name} / page ${page} result: ${cats.length}`);
    ...
    Promise.all(tasks)
        .then((allResponses) => {
            const result = allResponses.reduce((flattened, array) => flattened.concat(...array), []);
